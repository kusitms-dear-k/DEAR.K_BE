    ...
    public void run(ApplicationArguments args) {
        if (storeRepository.count() > 0) {
            ...
            Store DUMMY_STORE5 = Store.builder()
                    .user(OWNER5)
                    .name("마이레터")
                    .description("마이레터는 강북구 도봉로에 있는 포토·레터링 케이크 전문 공방입니다. 사진을 넣은 케이크, 문구 케이크, 특별한 테마 케이크까지 다양한 스타일을 제공합니다. 소량 제작 원칙으로 항상 신선한 케이크를 보장합니다.")
                    .address("서울특별시 강북구 도봉로 215")
                    .phone("02-5678-9012")
            ...
            Store DUMMY_STORE9 = Store.builder()
                    .user(OWNER3)
                    .name("미스틱케이크")
                    .description("미스틱케이크는 유니크한 스타일의 레터링 케이크를 제작하는 중랑구의 힙한 매장입니다. 색감과 폰트에 특별한 포인트를 주어 젊은 층 사이에서 인기가 높습니다. 단체 주문, 행사 주문도 가능합니다.")
                    .address("서울특별시 중랑구 중화로 27길 10")
                    .phone("02-7892-3456")
            ...
            Store DUMMY_STORE10 = Store.builder()
                    .user(OWNER4)
                    .name("그레이문")
                    .description("그레이문은 우아하고 세련된 레터링 케이크를 만드는 중랑구의 인기 매장입니다. 그레이, 베이지 톤의 미니멀 디자인을 주로 사용하며, 프라이빗 오더가 가능합니다. 품질 높은 원재료만을 고집합니다.")
                    .address("서울특별시 중랑구 면목로 73길 28")
                    .phone("02-7893-4567")
