    ...
    public void run(ApplicationArguments args) {
        if (storeRepository.count() > 0) {
            ...
            Store DUMMY_STORE1 = Store.builder()
                    ...
                    .latitude(37.50452746291375)
                    .longitude(127.02557815572708)
                    .phone("02-1234-5678")
            ...
            Store DUMMY_STORE3 = Store.builder()
                    ...
                    .address("서울특별시 송파구 잠실동 1")
                    .latitude(37.51832852686033)
                    .longitude(127.07306668545499)
                    .phone("02-3456-7890")
            ...
            Store DUMMY_STORE4 = Store.builder()
                    ...
                    .address("서울특별시 강서구 마곡동 1")
                    .latitude(37.577328282320664)
                    .longitude(126.8385431528618)
                    .phone("02-4567-8901")
            ...
            Store DUMMY_STORE5 = Store.builder()
                    ...
                    .address("서울특별시 강북구 미아동 1-14")
                    .latitude(37.618878642514446)
                    .longitude(127.03643270244766)
                    .phone("02-5678-9012")
            ...
            Store DUMMY_STORE6 = Store.builder()
                    ...
                    .address("서울특별시 강동구 천호동 1-2")
                    .latitude(37.55043987794787)
                    .longitude(127.13975116412061)
                    .phone("02-6789-0123")
            ...
            Store DUMMY_STORE7 = Store.builder()
                    ...
                    .address("서울특별시 중랑구 면목동 1-1")
                    .latitude(37.588966790634494)
                    .longitude(127.10194204191839)
                    .phone("02-7890-1234")
            ...
            Store DUMMY_STORE8 = Store.builder()
                    ...
                    .address("서울특별시 중랑구 망우동 1")
                    .latitude(37.606139919442526)
                    .longitude(127.11435397651877)
                    .phone("02-7891-2345")
            ...
            Store DUMMY_STORE9 = Store.builder()
                    ...
                    .address("서울특별시 중구 신당동 100")
                    .latitude(37.56422873729653)
                    .longitude(127.01609542292474)
                    .phone("02-7892-3456")
                    .businessNumber("792-03-45678")
                    .establishDate(LocalDate.of(2021, 2, 14))
                    .imageUrl(storeImageUrl + "/muffin.jpg")
                    .isSelfService(true)
                    .isSameDayOrder(false)
            ...
            Store DUMMY_STORE10 = Store.builder()
                    ...
                    .address("서울특별시 구로구 경인로 611-29 (신도림동)")
                    .latitude(37.506938177)
                    .longitude(126.883200692)
                    .phone("02-7893-4567")
                    .businessNumber("793-04-56789")
                    .establishDate(LocalDate.of(2022, 9, 9))
                    .imageUrl(storeImageUrl + "/pink.jpg")
                    .isSelfService(false)
                    .isSameDayOrder(true)
                    .chattingUrl("https://pf.kakao.com/_xkxlw")
                    .build();
